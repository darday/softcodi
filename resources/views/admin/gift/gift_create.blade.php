...
<body>
  ...
  <div class=" text-center container" style="padding-top:5vh; border:5px ">
    <div class="div text-center" style="padding-bottom: 5vh">
      <div class="row " style=" text-align:center">
        ...
        <h3 style="margin-top: -1vh"><b>AGREGAR SORTEO</b></h3>
      </div>
    </div>
  </div>
  ...
  <div class="container ">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{url('/admin/store-sorteo')}}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-4">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="gift_name" value="" placeholder="Ej: Mouse + Teclado" aria-label="Username" aria-describedby="basic-addon1" required>
            ...
            <div class="col-4">
              <div class="mb-3">
                ...
                <input type="date" class="form-control" name="draw_date" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
              </div>
            </div>
            ...
            <div class="col-4">
              <div class="mb-3">
                ...
                <input class="form-control" type="file" name='img_gift_draw' id="formFile">
              </div>
            </div>
            ...
            <div class="mb-3">
              <div class="row">
                <div class="form-floating">
                  <textarea class="form-control" name="gift_description" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">TE PRESENTAMOS EL PRODUCTO QUE SE ESTÁ SORTEANDO EN ESTA OCACIÓN 🪅🥳🤩🎉🎊</textarea>
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="date" class="form-control" name="date_claim_gift" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
                <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="gift_winner" value="" placeholder="" aria-label="Username" aria-describedby="basic-addon1" required>
                <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
              </div>
            </div>
            <div class="col-6">
              <div class="mb-3">
                ...
                <input class="form-control" type="file" name="img_gift_winner" id="formFile">
              </div>
            </div>
          </div>
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="claim_gift">
                  <option value="" selected>Seleccione Respuesta</option>
