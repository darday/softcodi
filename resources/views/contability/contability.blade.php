...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
            ...
            <div class=" text-center container" style="padding-top:5vh; border:5px ">
                <div class="div text-center" style="background-color: #f45f13 ; padding-bottom: 9vh">
                    <div class="row " style=" text-align:center">

                      <hr/>
                      <h1 class="titulo" style="color: white">ASESORES CONTABLES Y TRIBUTARIOS</h1>
                      <p style="margin-top: -2vh">Luis Yumiseba - Jhon Santos Especialistas Contables</p>
